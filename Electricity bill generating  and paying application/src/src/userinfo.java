...
public class userinfo extends javax.swing.JFrame {
    ...
    String name;
    int regno;
    public userinfo(String uname,int pass) {
    	name=uname;
    	regno=pass;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField3.setFont(new java.awt.Font("Times New Roman", 1, 13));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	try {
    	    Desktop.getDesktop().browse(new URL("https://www.upcl.org/wss/Consumer_Data.htm").toURI());
    	} catch (Exception e) {}
    }                                        

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       complain c=new complain(name,regno);
        c.setVisible(true);
